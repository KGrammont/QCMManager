...
/**
 * REST controller for managing {@link Qcm}.
 */
@RestController
@RequestMapping("/api")
public class QcmControllerFromResource {

    private final Logger log = LoggerFactory.getLogger(QcmControllerFromResource.class);
    ...
    public QcmControllerFromResource(QcmService qcmService, QcmRepository qcmRepository) {
