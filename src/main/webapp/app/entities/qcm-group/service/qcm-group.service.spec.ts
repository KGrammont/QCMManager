  ...
  describe('Service methods', () => {
    ...
    describe('addQcmGroupToCollectionIfMissing', () => {
      ...
      it('should add only unique QcmGroup to an array', () => {
        const qcmGroupArray: IQcmGroup[] = [{ id: 123 }, { id: 456 }, { id: 62178 }];
      ...
      it('should return initial array if no QcmGroup is added', () => {
        const qcmGroupCollection: IQcmGroup[] = [{ id: 123 }];
        expectedResult = service.addQcmGroupToCollectionIfMissing(qcmGroupCollection, undefined, null);
        expect(expectedResult).toEqual(qcmGroupCollection);
      });
    });
  });
