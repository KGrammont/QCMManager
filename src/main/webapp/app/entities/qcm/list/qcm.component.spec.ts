...
describe('Qcm Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'qcm', component: QcmComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.qcms?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
