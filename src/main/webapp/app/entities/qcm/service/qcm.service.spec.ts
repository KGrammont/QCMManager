  ...
  describe('Service methods', () => {
    ...
    describe('addQcmToCollectionIfMissing', () => {
      ...
      it('should add only unique Qcm to an array', () => {
        const qcmArray: IQcm[] = [{ id: 123 }, { id: 456 }, { id: 84614 }];
      ...
      it('should return initial array if no Qcm is added', () => {
        const qcmCollection: IQcm[] = [{ id: 123 }];
        expectedResult = service.addQcmToCollectionIfMissing(qcmCollection, undefined, null);
        expect(expectedResult).toEqual(qcmCollection);
      });
    });
  });
