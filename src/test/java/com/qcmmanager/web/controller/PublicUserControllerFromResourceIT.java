...
import com.qcmmanager.web.rest.UserResourceIT;
...
@IntegrationTest
class PublicUserControllerFromResourceIT {
    ...
    void getAllAuthorities() throws Exception {
        restUserMockMvc
            ...
            .andExpect(jsonPath("$").value(hasItems(AuthoritiesConstants.PROF, AuthoritiesConstants.ADMIN)));
    }
