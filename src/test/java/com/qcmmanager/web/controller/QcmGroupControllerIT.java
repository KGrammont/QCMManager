...
import com.qcmmanager.web.rest.QcmGroupResource;
...
class QcmGroupControllerIT {
    ...
    public static QcmGroup createEntity(EntityManager em) {
        ...
        if (TestUtil.findAll(em, Classe.class).isEmpty()) {
            classe = ClasseControllerIT.createEntity(em);

            User student1 = UserControllerIT.createEntity();
            student1.setLogin(student1.getLogin() + "1");
            student1.setEmail(student1.getEmail() + "1");
            em.persist(student1);
            em.flush();
            User student2 = UserControllerIT.createEntity();
            student2.setLogin(student2.getLogin() + "2");
            student2.setEmail(student2.getEmail() + "2");
            em.persist(student2);
            em.flush();
            User student3 = UserControllerIT.createEntity();
