package com.qcmmanager.security.jwt;

import static org.assertj.core.api.Assertions.assertThat;

import com.qcmmanager.management.SecurityMetersService;
...
class JWTFilterTest {
    ...
    void testJWTFilter() throws Exception {
        UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken(
            "test-user",
            "test-password",
            Collections.singletonList(new SimpleGrantedAuthority(AuthoritiesConstants.PROF))
        );
